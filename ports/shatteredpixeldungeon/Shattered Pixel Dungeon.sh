...
GAMEDIR=/$directory/ports/shatteredpixeldungeon
java_runtime="zulu17.54.21-ca-jre17.0.13-linux"
jar_filename="ShatteredPD.jar"
gptk_filename="shatteredpixeldungeon.gptk"
...
$ESUDO env CRUSTY_SHOW_CURSOR=1 $weston_dir/westonwrap.sh headless noop kiosk crusty_glx_gl4es \
