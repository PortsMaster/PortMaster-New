...
function profile.hooker(event, line, info)
  ...
  -- CUSTOM CHANGE (delete this if it causes problems): DON'T PROFILE FUNCTIONS WITHOUT NAMES (should help us avoid certain coroutines from cluttering the profiler)
