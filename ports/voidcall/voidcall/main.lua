...
function love.load()
	...
	FONT_MAIN = lg.newFont("graphics/fonts/ChevyRay-Express.ttf",9)FONT_MAIN:setFilter( "nearest", "nearest" )
	FONT_CONSOLE = lg.newFont("graphics/fonts/ChevyRay-Express.ttf",9)FONT_CONSOLE:setFilter( "nearest", "nearest" )
	FONT_PICO = lg.newFont("graphics/fonts/PICO-8_mono.ttf",4)FONT_PICO:setFilter( "nearest", "nearest" )
...
--
--		
--		-- render scanline canvas onto output and scale up
--		-- also apply simple vignette and distortion to screen
--		lg.setCanvas()
