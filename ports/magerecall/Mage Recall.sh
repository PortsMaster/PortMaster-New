...
if [ -f "$GAMEDIR/gamedata/MageRecall.7z.001" ]; then
    "$controlfolder/7zzs.${DEVICE_ARCH}" x "$GAMEDIR/gamedata/MageRecall.7z.001" -o"$GAMEDIR/gamedata"
    rm -f "$GAMEDIR/gamedata"/MageRecall.7z.*
fi
