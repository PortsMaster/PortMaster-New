# Building the Wratch's Den Port
...
cd port
rm -f wratchsden.zip
zip -r wratchsden.zip wratchsden/ "The Wratch's Den.sh" \
    -x "wratchsden/gamedata/*" "wratchsden/userdata/*"
```
