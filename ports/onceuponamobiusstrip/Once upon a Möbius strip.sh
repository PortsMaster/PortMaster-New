...
# Variables
GAMEDIR=/$directory/ports/onceuponamobiusstrip
...
sed -i -E "s/(dpad_mouse_step|deadzone_scale) = [0-9]+/\1 = $value/g" "onceuponamobiusstrip.gptk"
...
$GPTOKEYB "$LOVE_GPTK" -c "./onceuponamobiusstrip.gptk"  &
