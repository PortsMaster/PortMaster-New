...
GAMEDIR=/$directory/ports/blipnblup
BINARY=blipnblup.${DEVICE_ARCH}
...
if [[ -f "$ARCHIVE_FILE" ]]; then
    ...
    pm_message "Error: No Resources directory present and Archive file $ARCHIVE_FILE not found."
    sleep 5
    exit 1
fi
