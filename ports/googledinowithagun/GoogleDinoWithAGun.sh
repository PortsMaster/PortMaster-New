...
# Variables
GAMEDIR="/$directory/ports/googledinowithagun"
gptk_filename="googledinowithagun.gptk"
...
export PATCHER_GAME="GoogleDinoWithAGun"
export PATCHER_TIME="30 seconds minutes"
