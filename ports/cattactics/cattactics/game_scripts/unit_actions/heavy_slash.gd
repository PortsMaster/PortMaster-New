...
set_variable("unit_action_missed_message", "The attack missed!")
set_variable("unit_action_damage_message", "%s's claws ripped through %s and dealt %s damage!" % [get_variable("unit_action_attacking").get_unit_name(), get_variable("unit_action_attacked").get_unit_name(), get_variable('unit_action_result')['damage']])
