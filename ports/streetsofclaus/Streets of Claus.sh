#!/bin/bash
# PORTMASTER: streetsofclaus.zip, Streets of Claus.sh
...
GAMEDIR="/$directory/ports/streetsofclaus"
...
if [ -n "$(ls ./gamedata/*.ogg 2>/dev/null)" ]; then
    ...
    zip -r -0 ./streetsofclaus.apk ./assets/ || exit 1
...
$GPTOKEYB "gmloader" -c ./streetsofclaus.gptk &

$ESUDO chmod +x "$GAMEDIR/gmloader"

./gmloader streetsofclaus.apk
