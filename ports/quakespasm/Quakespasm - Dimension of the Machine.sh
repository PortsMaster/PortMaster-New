...
if [ ! -f "$GAMEDIR/mg1/pak0.pak" ]; then
    ./text_viewer.${DEVICE_ARCH} -f 25 -w -t "Missing gamedata" -m "Please place your pak0.pak into the ports/quakespasm/mg1 directory.  Press 'Select' to exit this text viewer."
    exit 1
fi
