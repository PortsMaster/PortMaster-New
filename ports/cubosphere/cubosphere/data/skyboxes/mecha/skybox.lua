...
--Rotatate the  Skybox around all three cartesian axes by some time dependent angles
  MATRIX_AxisRotate(VECTOR_New(0,1,0),120*math.sin(3+0.25*GLOBAL_GetTime()));
  MATRIX_AxisRotate(VECTOR_New(0,0,1),290*math.sin(5+0.133*GLOBAL_GetTime()));
  MATRIX_AxisRotate(VECTOR_New(1,0,0),GLOBAL_GetTime()*1.37*0.5+2);
