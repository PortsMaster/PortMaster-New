...
snd_pickup=SOUND_Load("jump_minus");
...
local minsprungweite=2; sprungweite=ACTOR_GetVar(actorid,"JumpDistance")-1;  --
if sprungweite<minsprungweite then sprungweite=minsprungweite; 
end;
