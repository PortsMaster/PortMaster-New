...
snd_pickup=SOUND_Load("pickup_diamond2");

pickupcolor=COLOR_New(0.1,0.0,0.6,0.4);


function Precache()
  mdl=MDLDEF_Load("diamond3");
  PrecacheShadow();
end;
...
function Collide(actorid,itemid)
  ...
  local plr=ACTOR_GetPlayer(actorid);   PLAYER_SetVar(plr,"Score",PLAYER_GetVar(plr,"Score")+5000);
