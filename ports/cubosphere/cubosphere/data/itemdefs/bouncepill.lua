...
function Collide(actorid,itemid)
  ...
  if ACTOR_GetVar(actorid,"NoJump")==1 then
    ACTOR_SetVar(actorid,"NoJump",0);
    ACTOR_SetJumpTiming(actorid,0.15,0.10,0.075);
  else
    ACTOR_SetVar(actorid,"Bounce",1);
    ACTOR_SetJumpTiming(actorid,0.15,0.10,-1);
  end;
