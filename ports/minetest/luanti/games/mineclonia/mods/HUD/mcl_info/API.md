# mcl_info
An api to make custom entries in the Mineclonia debug hud.
...
Table the debug definitions are stored in. Do not modify this directly.
If you need to overwrite a field just set it again with mcl_info.register_debug_field().
