...
# Variables
GAMEDIR=/$directory/ports/dumbasssmartass
...
sed -i -E "s/(dpad_mouse_step|deadzone_scale) = [0-9]+/\1 = $value/g" "dumbasssmartass.gptk"
...
$GPTOKEYB "$LOVE_GPTK" -c "./dumbasssmartass.gptk"  &
