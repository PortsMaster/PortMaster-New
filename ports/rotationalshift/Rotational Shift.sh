#!/bin/bash
# PORTMASTER: rotationalshift.zip, Rotational Shift.sh
...
GAMEDIR=/$directory/ports/rotationalshift
...
$GPTOKEYB "gmloader" -c ./rotationalshift.gptk &

$ESUDO chmod +x "$GAMEDIR/gmloader"

./gmloader rotationalshift.apk
