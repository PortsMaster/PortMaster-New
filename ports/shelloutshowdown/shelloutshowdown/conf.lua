function love.conf(t)
    t.identity = "ShellOutShowdown"                    -- The name of the save directory (string)
    ...
    t.window.title = "Shell Out Showdown"         -- The window title (string)
    t.window.icon = "icon.png"                 -- Filepath to an image to use as the window's icon (string)
    t.window.minwidth = 384                -- The window width (number)
    t.window.minheight = 216               -- The window height (number)
