...
GAMEDIR=/$directory/ports/minimonstersgravity
godot_runtime="godot_4.3"
godot_executable="godot43.$DEVICE_ARCH"
pck_filename="MiniMonsters.pck"
gptk_filename="minimonstersgravity.gptk"
...
$ESUDO env CRUSTY_BLOCK_INPUT=1 CRUSTY_SHOW_CURSOR=1 $weston_dir/westonwrap.sh headless noop kiosk crusty_x11egl \
