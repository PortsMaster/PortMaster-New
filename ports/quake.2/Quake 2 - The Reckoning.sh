...
if [[ ! -f "$GAMEDIR/xatrix/pak0.pak" ]]; then
    ./text_viewer.${DEVICE_ARCH} -f 25 -w -t "Missing gamedata" -m "Please place your pak0.pak into the ports/quake2/xatrix directory and, optionally, the music tracks in ports/quake2/xatrix/music and the .cin cutscenes in ports/quake2/xatrix/video!"
    exit
fi
