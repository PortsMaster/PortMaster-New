...
This is a wrapper and modification for vanilla UFO50 that makes the game more manageable on retro handheld systems running linux arm64. If you are running android on a retro handheld system, you may be looking for the [unofficial android port](https://github.com/Skyline969/UFO50AndroidUnofficial) by Skyline969.
...
- [GMToolkit](https://github.com/JeodC/gmtoolkit) by Jeod to convert WAV to OGG and lower their bitrate, and also to make some specific changes to the game:
