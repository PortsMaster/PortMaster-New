...
// this should probably be any small screen touch-device, i don't know the defines for all of them so i'll cover android and IOS as i imagine they're more common
	...
	_info.push_back(OptionInfo("keyGeoZoomIn", &keyGeoZoomIn, SDLK_PAGEDOWN, "STR_ZOOM_IN", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyGeoZoomOut", &keyGeoZoomOut, SDLK_PAGEUP, "STR_ZOOM_OUT", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyGeoSpeed1", &keyGeoSpeed1, SDLK_r, "STR_5_SECONDS", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyGeoSpeed2", &keyGeoSpeed2, SDLK_2, "STR_1_MINUTE", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyGeoSpeed3", &keyGeoSpeed3, SDLK_n, "STR_5_MINUTES", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyGeoSpeed4", &keyGeoSpeed4, SDLK_l, "STR_30_MINUTES", "STR_GEOSCAPE"));
	...
	_info.push_back(OptionInfo("keyGeoIntercept", &keyGeoIntercept, SDLK_t, "STR_INTERCEPT", "STR_GEOSCAPE"));
	...
	_info.push_back(OptionInfo("keyGeoToggleRadar", &keyGeoToggleRadar, SDLK_UNKNOWN, "STR_TOGGLE_RADAR_RANGES", "STR_GEOSCAPE"));
	...
	_info.push_back(OptionInfo("keyBattleNextUnit", &keyBattleNextUnit, SDLK_n, "STR_NEXT_UNIT", "STR_BATTLESCAPE"));
	...
	_info.push_back(OptionInfo("keyBattleUseRightHand", &keyBattleUseRightHand, SDLK_t, "STR_USE_RIGHT_HAND", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleInventory", &keyBattleInventory, SDLK_b, "STR_INVENTORY", "STR_BATTLESCAPE"));
	...
	_info.push_back(OptionInfo("keyBattleEndTurn", &keyBattleEndTurn, SDLK_r, "STR_END_TURN", "STR_BATTLESCAPE"));
	...
	_info.push_back(OptionInfo("keyBattleReload", &keyBattleReload, SDLK_UNKNOWN, "STR_RELOAD", "STR_BATTLESCAPE"));
	...
	// OXCE
	_info.push_back(OptionInfo("keyBasescapeBuildNewBase", &keyBasescapeBuildNewBase, SDLK_UNKNOWN, "STR_BUILD_NEW_BASE_UC", "STR_OXCE"));
	...
	_info.push_back(OptionInfo("keyBasescapeResearch", &keyBasescapeResearch, SDLK_UNKNOWN, "STR_RESEARCH", "STR_OXCE"));
	_info.push_back(OptionInfo("keyBasescapeManufacture", &keyBasescapeManufacture, SDLK_m, "STR_MANUFACTURE", "STR_OXCE"));
	_info.push_back(OptionInfo("keyBasescapeTransfer", &keyBasescapeTransfer, SDLK_UNKNOWN, "STR_TRANSFER_UC", "STR_OXCE"));
	_info.push_back(OptionInfo("keyBasescapePurchase", &keyBasescapePurchase, SDLK_UNKNOWN, "STR_PURCHASE_RECRUIT", "STR_OXCE"));
	_info.push_back(OptionInfo("keyBasescapeSell", &keyBasescapeSell, SDLK_UNKNOWN, "STR_SELL_SACK_UC", "STR_OXCE"));
	...
	_info.push_back(OptionInfo("keyGeoUfoTracker", &keyGeoUfoTracker, SDLK_UNKNOWN, "STR_UFO_TRACKER", "STR_OXCE"));
	_info.push_back(OptionInfo("keyGeoTechTreeViewer", &keyGeoTechTreeViewer, SDLK_q, "STR_TECH_TREE_VIEWER", "STR_OXCE"));
	_info.push_back(OptionInfo("keyGeoGlobalProduction", &keyGeoGlobalProduction, SDLK_UNKNOWN, "STR_PRODUCTION_OVERVIEW", "STR_OXCE"));
	...
	_info.push_back(OptionInfo("keyInvLoadPersonalEquipment", &keyInvLoadPersonalEquipment, SDLK_UNKNOWN, "STR_LOAD_PERSONAL_EQUIPMENT", "STR_OXCE"));
	_info.push_back(OptionInfo("keyInvShowPersonalEquipment", &keyInvShowPersonalEquipment, SDLK_UNKNOWN, "STR_PERSONAL_EQUIPMENT", "STR_OXCE"));
