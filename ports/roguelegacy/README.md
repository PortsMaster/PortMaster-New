...
Special thanks to [Cellar Door Games](https://www.cellardoorgames.com/) for making this wonderful game as well as making the source code available which aided the creation of this port!
...
| Button | Action |
|--|--| 
|Controls: D-pad / L-stick|Movement|
|A|Jump / Select|
|B|Spell / Back|
|X|Attack|
|Y|Special|
|L2 / R2|Dash Left / Right|
|Start|Pause / Menu|
|Select|Map|
