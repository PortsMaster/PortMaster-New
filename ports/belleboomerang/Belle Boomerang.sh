...
GAMEDIR="/$directory/ports/belleboomerang"
...
if [ -f "./gamedata/data.win" ]; then
    ...
    if [ "$checksum" = "266bf7b83f95ca3ad8fbae7833147f31" ]; then
...
if [ -n "$(ls ./gamedata/*.dat 2>/dev/null)" ]; then
    ...
    rm -Rf "$GAMEDIR/gamedata/Belle Boomerang.exe" \
...
$GPTOKEYB "gmloadernext" -c "./belleboomerang.gptk" &
