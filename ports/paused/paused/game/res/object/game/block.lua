...
function object:create(entity)
    ...
    self.block = resource.image("block.png")
    self.blockHidden = resource.image("block-hidden.png")
    self.collision_rectangle = collision.rectangle(entity.x, entity.y - 1, 8, 8)
