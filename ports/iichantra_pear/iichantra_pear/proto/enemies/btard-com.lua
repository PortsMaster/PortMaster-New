...
animations = 
{
	...
	{ 
		...
		frames = 
		{
			...
			{ com = constants.AnimComJumpIfTargetClose; param = 32 },
	...
	{ 
		...
		frames = 
		{
			...
			{ com = constants.AnimComPushInt; param = 50 },
			{ com = constants.AnimComJumpRandom; param = 10 },
			{ com = constants.AnimComPushInt; param = 0 },
			{ com = constants.AnimComPushInt; param = 0 },
			...
			--{ dur = 100; num = 25, com = constants.AnimComCreateObject; txt = "btard-corpse"; param = 1 },			{ com = constants.AnimComRealH; param = 21 },
			{ dur = 5000; num = 27 },
			{ com = constants.AnimComPushInt; param = 320 },
			{ com = constants.AnimComPushInt; param = 240 },
			{ dur = 1; num = 27; com = constants.AnimComJumpIfCloseToCamera; param = 34 }
